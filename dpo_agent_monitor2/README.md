...
This project investigates whether an LLM-based agent can effectively monitor Direct Preference Optimization (DPO) training logs in real-time and detect failure modes such as **reward hacking** and **overfitting** and **model collapse** comparing its performance against heuristic baselines.
...
# change the name of the full epochs logs as training_run_1.jsonl in logs/
